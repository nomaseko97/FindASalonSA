...
class TodoItemController extends SuperAdminBaseController
{
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            ->addColumn('action', function ($row) {
                $action = '<div class="text-right"><a href="javascript:showUpdateTodoForm(' . $row->id . ');" class="btn btn-primary btn-circle edit-todo" data-toggle="tooltip" data-original-title="'.__('app.edit').'"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="javascript:deleteTodoItem(' . $row->id . ');" class="btn btn-danger btn-circle delete-todo" data-toggle="tooltip" data-original-title="'.__('app.delete').'"><i class="fa fa-times" aria-hidden="true"></i></a></div>';
        ...
        return view('superadmin.todo-list.index');
    }

    public function create(Request $request)
    {
        return view('superadmin.todo-list.todo-item-create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('superadmin.todo-list.todo-item-edit', compact('todoItem'));
    }
    ...
    public function store(StoreTodo $request)
    {
        ...
        if (request()->server('HTTP_REFERER') == route('superadmin.dashboard')) {
