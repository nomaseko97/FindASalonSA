<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{$user->is_superadmin ? route('superadmin.todo-items.index') : route('admin.todo-items.index') }}" class="btn btn-sm btn-custom">
        ...
        @forelse ($pendingTodos as $todo)
            <li data-id="{{ $todo->id }}" data-position="{{ $todo->position }}" class="draggable list-group-item">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <p class="mb-0">{{ $todo->created_at->translatedFormat($dateFormat) }}</p>
