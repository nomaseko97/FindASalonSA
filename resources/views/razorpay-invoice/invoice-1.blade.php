...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div class="date">@lang('modules.invoices.issueDate'): {{ $invoice->pay_date->format($global->date_format) }}</div>
        </div>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr id="pb">
            ...
            <td class="qty"></td>
            <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ number_format((float)$invoice->amount, 2, '.', '') }}</td>
        </tr>
        </tbody>
        <tfoot>
        <tr dontbreak="true">
            <td colspan="4">@lang("modules.invoices.total")</td>
            <td id="tac">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ number_format((float)$invoice->amount, 2, '.', '') }}</td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
    <hr>
    <p id="notes">
        @lang("app.note"): @lang("app.here") {!! htmlentities($invoice->currency->currency_symbol)  !!} refers to {!! $invoice->currency->currency_code  !!}<br>
    </p>
</main>
</body>
</html>
