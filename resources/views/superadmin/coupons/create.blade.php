                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input onkeypress="return isNumberKey(event)" type="number" class="form-control" name="uses_time" min="0">
                                <span class="help-block">@lang('messages.howManyTimeUserCanUse')</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>@lang('app.discountType')</label>
                        ...
                        <div class="col-md-6">
                            <!-- text input -->
                            <div class="form-group">
                                <label>@lang('app.percent') / @lang('app.amount')</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input onkeypress="return isNumberKey(event)" type="number" class="form-control" name="minimum_purchase_amount" min="0">
